    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            What value does subscribing to your newsletter provide?
          </h2>
          <p
          ...
          >
            Subscribing to the worklife newsletter provides you with essential updates about the industry and valuable insights on how to balance your work and personal life. Receive exclusive content and stay ahead with early access to new products.
          </p>
